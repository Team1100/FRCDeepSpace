...
public class Middle_RightRocket extends Command {
  ...
  public Middle_RightRocket() {
    requires(Drive.getInstance());

    ioerror = false;

    leftCSV = new File("/home/lvuser/deploy/output/Middle_RightRocket.left.pf1.csv");
    rightCSV = new File("/home/lvuser/deploy/output/Middle_RightRocket.right.pf1.csv");
